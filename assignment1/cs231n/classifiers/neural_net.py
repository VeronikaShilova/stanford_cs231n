...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None, reg=0.0):
        ...
        grads['W2'] = (hidden_layer.T).dot(probs)
        grads['W2'] /= num_train
        grads['W2'] += 2. * reg * W2
        grads['b2'] = np.sum(probs, axis=0) / num_train
        ...
        grads['W1'] /= num_train
        grads['W1'] += 2. * reg * W1
        grads['b1'] = np.sum(dhidden_layer, axis=0) / num_train
    ...
    def predict(self, X):
        ...
        scores = np.maximum(0, X.dot(self.params['W1']) + self.params['b1'])
